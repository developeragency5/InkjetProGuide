                ...
                <div className="flex gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-muted-foreground" data-testid="text-step-1">
                      Email us at <a href="mailto:support@injetproguide.com" className="text-primary hover:underline" data-testid="link-email-support-step1">support@injetproguide.com</a> or call <a href="tel:+18005551234" className="text-primary hover:underline" data-testid="link-phone-support-step1">1-800-555-1234</a> with your order number to initiate a return.
                    </p>
                  </div>
                </div>
              ...
              <div className="grid md:grid-cols-2 gap-6">
                ...
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <a href="tel:+18005551234" className="text-primary hover:underline" data-testid="link-phone-support">
                      1-800-555-1234
                    </a>
