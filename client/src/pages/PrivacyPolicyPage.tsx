              ...
              <Card>
                ...
                <CardContent className="prose prose-slate dark:prose-invert max-w-none space-y-4">
                  <p className="text-muted-foreground leading-relaxed" data-testid="text-intro-1">
                    Welcome to InkjetProGuide, your trusted independent inkjet printer retailer serving customers throughout the United States. We are committed to protecting your personal information and your right to privacy. This Privacy Policy describes how we collect, use, disclose, and safeguard your information when you visit our website, make a purchase, create an account, or otherwise interact with our services. InkjetProGuide operates as an independent e-commerce retailer specializing in high-quality inkjet printers from leading manufacturers, printer accessories, ink cartridges, and related supplies. We are headquartered in Fort Worth, Texas, and pride ourselves on delivering exceptional products and customer service while maintaining the highest standards of data protection and privacy compliance.
                  </p>
                  <p className="text-muted-foreground leading-relaxed" data-testid="text-intro-2">
                    This Privacy Policy applies to all information collected through our website (inkjetproguide.com), as well as any related services, sales, marketing, or events conducted by InkjetProGuide. We have carefully designed this policy to be transparent about our data practices and to give you meaningful control over your personal information. By accessing or using our website, placing an order, creating an account, subscribing to our newsletter, or contacting our customer service team, you acknowledge that you have read and understood this Privacy Policy and agree to its terms. If you do not agree with our policies and practices, please discontinue use of our services immediately. We encourage you to review this policy periodically, as we may update it from time to time to reflect changes in our practices, legal requirements, or industry standards.
                  </p>
