                  ...
                  <div className="space-y-4">
                    ...
                    <div className="border rounded-lg p-4">
                      ...
                      <p className="text-muted-foreground text-sm leading-relaxed" data-testid="text-payment">
                        Payment information is collected and processed securely through our payment processor. We do not store, process, or have access to your complete credit card numbers, debit card numbers, or bank account information on our servers. When you make a purchase, your payment card data is transmitted using industry-standard encryption protocols. Our payment processor returns only limited transaction information to us, including the last four digits of your card number (for your reference and verification purposes), card type (Visa, Mastercard, etc.), expiration status, billing address verification results, and transaction authorization codes. We collect only the information necessary to process payments and fulfill orders. Payment details are handled by our payment processor, and we do not store full card numbers on our servers.
                      </p>
                    </div>
                  </div>
                </CardContent>
