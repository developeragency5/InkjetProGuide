...
export default function CartPage() {
  ...
  return (
    <div className="min-h-screen bg-background py-12">
      <SEOHead page="cart" fallbackTitle="Shopping Cart | InkjetProGuide" />
            ...
            <Card className="sticky top-24">
              <CardContent className="p-6">
                ...
                <div className="mt-6 pt-6 border-t space-y-3">
                  ...
                  <div className="flex items-center gap-2 text-sm">
                    <span className="text-primary">✓</span>
                    <span className="text-muted-foreground">30-day returns per Return Policy</span>
                  </div>
                  <div className="flex items-center gap-2 text-sm">
                    <span className="text-primary">✓</span>
                    <span className="text-muted-foreground">Serving customers in the United States</span>
                  </div>
                </div>
              </CardContent>
            </Card>
